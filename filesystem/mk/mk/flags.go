...
import(
	...
	"github.com/ProhtMeyhet/gonixutils/filesystem/mk"
...
func NewMkFlags() *MkFlags {
	return &MkFlags{}
}

func (flags *MkFlags) GetInput() *mk.Input {
	return &flags.Input
}

func (flags *MkFlags) Parse() {
